...
import datakeyboard.db.DBHandler;
...
public class FXMLDocumentController implements Initializable {
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        System.out.println(idPel.getText());
        ...
        Keyboard key = new Keyboard(idPel.getText(),tfNama.getText(),dpTanggalBeli.getValue().toString(),
